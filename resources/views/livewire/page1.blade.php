<nav class="bg-gradient">
    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex-shrink-0 flex items-center">
          <img class="block lg:hidden h-10 w-auto" src="../../img/logo-masa.png" alt="Workflow">
          <img class="hidden lg:block h-10 w-auto" src="../../img/logo-masa.png" alt="Workflow">
        </div>
        ...
        <div class="hidden sm:block sm:ml-6">
          <div class="flex space-x-4">
            ...
            <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">How to Install</a>          
  ...
  <div class="sm:hidden" id="mobile-menu">
    <div class="hidden px-2 pt-2 pb-3 space-y-1">
      ...
      <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">How to Install</a>      
